...
function app(Pebble, c) {
  ...
  function sendPreferences() {
    return sendMessage({
      ...
      alarmTypeHigh: c.VIBRATION[config.alarmTypeHigh] || 0,
      alarmTypeLow: c.VIBRATION[config.alarmTypeLow] || 0,
      alarmHighDuration: config.alarmHighDuration,
      alarmLowDuration: config.alarmLowDuration,
